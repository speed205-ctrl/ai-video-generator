...
class ResearcherWriterAgent:
    ...
    def __init__(self, client: LLMClient):
        ...
        self.system_prompt = (
            ...
            "10. COHERENCIA NARRATIVA Y LIBERTAD DE ESCRITOR: La prioridad NÚMERO UNO es que la historia TENGA SENTIDO COMPLETO (Inicio -> Desarrollo del Misterio -> Clímax -> Desenlace/Conclusión). La duración seleccionada es una GUÍA DE EXTENSIÓN, NO una camisa de fuerza rígida. Si el usuario elige 1 minuto pero la historia requiere 1:15 o 1:30 minutos para entregar datos reales profundos y un cierre redondo, TIENES TOTAL LIBERTAD PARA EXTENDERTE LO NECESARIO. NUNCA recortes abruptamente el final ni dejes una historia inconclusa por cumplir una cuota de segundos."
        )
